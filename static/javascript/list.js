require(['static/javascript/common.js', 'http://cdnjs.cloudflare.com/ajax/libs/jstree/3.3.3/jstree.min.js', 'http://cdnjs.cloudflare.com/ajax/libs/jstree/3.3.3/jstree.min.js'], function() {
    ...
    // TODO jsTree here
    // function() {
        //httpRequest로 json.go 적용
		treeObject = httpRequest('GET', '/filelist').then(function(response) {

			console.log(JSON.parse(response));
			$('#container').jstree(JSON.parse(response));
			return response;
		});
